...
-- CreateEnum
CREATE TYPE "UserType" AS ENUM ('LEAD', 'CUSTOMER');

-- CreateEnum
CREATE TYPE "ReportType" AS ENUM ('FINANCE', 'ESTIMATION');
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "Administrator"("id") ON DELETE SET NULL ON UPDATE CASCADE;
